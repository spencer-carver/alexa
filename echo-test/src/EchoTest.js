...
function onIntent(intentRequest, session, callback) {
    ...
    if ("EchoIntent" === intentName) {
        echoReply(intent, session, callback);
...
function getStopResponse(callback) {
    var cardTitle = "Stop";
    var speechOutput = "Exiting echo mode.";
    var repromptText = "";
...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "Entering echo mode. " +
        "I will now repeat everything you say until I hear 'stop', or it stays quiet for 5 seconds.";
...
function echoReply(intent, session, callback) {
    ...
    speechOutput = wordsToRepeat.value;
    repromptText = "";
